...
import jio.System.*;public abstract class ValueType {public NObject javonetHandle; public ValueType(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
